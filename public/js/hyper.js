...
!function ($) {
  ...
  LeftSidebar.prototype.initMenu = function () {
    ...
    if ($(".side-nav").length) {
      ...
      navCollapse.on({
        'show.bs.collapse': function showBsCollapse(event) {
    ...
    AllNavs.forEach(function (element) {
      element.addEventListener('click', function (event) {
        if (!element.parentElement.classList.contains('nav-item')) {
          isInner = true; //element.parentElement.parentElement.classList.add('show');
  ...
  */
  ...
  RightBar.prototype.init = function () {
    ...
    $('input[type=checkbox][name=color-scheme-mode]').change(function () {
      switch ($(this).val()) {
        case 'light':
          $.App.deactivateDarkMode(); // $.App.activateDefaultSidebarTheme();
...
!function ($) {
  ...
  */
  ...
  var Portlet = function Portlet() {
    this.$body = $("body"), this.$portletIdentifier = ".card", this.$portletCloser = '.card a[data-bs-toggle="remove"]', this.$portletRefresher = '.card a[data-bs-toggle="reload"]';
  }; //on init
