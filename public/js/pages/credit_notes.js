...
$(document).ready(function () {
  ...
  */
  ...
  $('#delete-modal').on('show.bs.modal', function (e) {
    var route = globalSettings.credit_note_items_delete;
  ...
  $('#delete-modal-order').on('show.bs.modal', function (e) {
    var route = globalSettings.credit_note_delete;
    var button = e.relatedTarget;
    if (button != null) {
      route = route.replace(':id', button.id);
  ...
  $('#create-invoice-modal-order').on('show.bs.modal', function (e) {
    var route = globalSettings.credit_note_confirm;
    var button = e.relatedTarget;
    if (button != null) {
      route = route.replace(':id', button.id);
    ...
    $.ajax({
      ...
      success: function success(data) {
        if (existing_item_id > 0) {
          ...
          item += '</td>';
          item += '</tr> ';
          $('#credit-note-items-table > tbody:last-child').append(item);
          $('.no-items').remove();
        }
