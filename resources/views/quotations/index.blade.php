        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table table-centered table-striped table-bordered table-hover w-100 dt-responsive nowrap table-has-dlb-click" id="quotations-datatable">
...
@section('page-scripts')
 ...
 $(document).ready(function () {
    ...
    // Default Datatable
    var table = $('#quotations-datatable').DataTable({
        dom: 'Bfrtip',
        stateSave: true,
        //scrollY: "500px",
        paging: true,
        buttons: [
            {
                text: '<i class="mdi mdi-plus-circle me-2"></i> {{ __('app.add_title', ['field' => 'quotation']) }}',
        ...
        serverSide: true,
        ajax: {
            url     : "{{ route('quotations.datatables') }}",
            data    : function(d) {
            ...
            /*
            {
                ...
                'render' : function(data, type, row, meta){
                    if (type === 'display'){
                        ...
                        var edit_route = '{{ route("quotations.show", ":id") }}';
                        edit_route = edit_route.replace(':id', row.quotation_number_slug);
    ...
    $('#quotations-datatable').on('dblclick', 'tr', function () {
        var route = '{{  route("quotations.show", ":id") }}';
        route = route.replace(':id', table.row( this ).data().quotation_number_slug);
