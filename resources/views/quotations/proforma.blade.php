...
<html lang="en">
  ...
  <head>
    ...
    <meta charset="utf-8">
    <title>Sunlit Future - Quotation</title>
  ...
  <div id="container">
    ...
    <section id="invoice-title-number">
      ...
      <table>
        <tr>
          <td colspan="3">
            <span id="number">Quotation #{{ $order->quotation_number }}</span>
          </td>
        </tr>
        @if(!is_null($order->confirmed_at))
          <tr>
            <td style="text-align: right; width:15%;"><span>Confirmed On:</span></td>
            <td><span>&nbsp;{{ $order->display_confirmed_at}}</span></td>
            <td></td>
          </tr>
        @elseif(!is_null($order->pending_at))
          <tr>
            <td style="text-align: right; width:15%;"><span>Pending On:</span></td>
            <td><span>&nbsp;{{ $order->display_pending_at}}</span></td>
            <td></td>
          </tr>
        @else
          <tr>
            <td style="text-align: right; width:15%;"><span>Created On:</span></td>
