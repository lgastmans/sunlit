...
@section('page-title',)
    {{ $product->part_number }} | {{$product->notes}}
@endsection
...
<ul id="nav-product" class="nav nav-tabs nav-bordered mb-3">
    <li class="nav-item">
        <a href="#" data-related="product-movement" data-bs-toggle="tab" aria-expanded="false" class="nav-link active">
            Movement
        </a>
    </li>
    <li class="nav-item">
        <a href="#" data-related="product-details" data-bs-toggle="tab" aria-expanded="false" class="nav-link">
            Details
        </a>
    </li>
</ul> <!-- end nav-->
...
<div class="tab-content">
    ...
    <div class="tab-pane show active" id="product-movement">
        <div class="card">
            <div class="card-body">
    ...
    </div> <!-- product-movement pane -->


    <div class="tab-pane show" id="product-details">
        <div class="row">
...
$(document).ready(function () {
    ...
    $("#nav-product li a").on("click", function() {
        $("div[id=product-movement]").hide();
        $("div[id=product-details]").hide();
